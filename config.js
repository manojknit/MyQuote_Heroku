...
exports.creds = {
	// Required
	identityMetadata: 'https://login.microsoftonline.com/cloudjibe.onmicrosoft.com/.well-known/openid-configuration', 
	...
	clientID: 'f51efea0-d15b-482c-9b28-6fe2da3414d6',
    ...
    redirectUrl: 'http://localhost:8080/auth/openid/return',//'http://localhost:3000/auth/openid/return', 
    //redirectUrl: 'https://fierce-oasis-28208.herokuapp.com/auth/openid/return',
	...
	clientSecret: 'Ch8drUwTeA/2mWtIxMJaC7XDZbI8JEBmfCTkt22o9aU=', 
...
//  exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=https://fierce-oasis-28208.herokuapp.com';
  ...
  exports.databaseUri = 'mongodb://quoteuser:Monday1$@ds259105.mlab.com:59105/quotedb';//'mongodb://localhost/OIDCStrategy';
